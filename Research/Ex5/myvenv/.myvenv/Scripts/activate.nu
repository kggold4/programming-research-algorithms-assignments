...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'D:\Projects\Development\Courses\Python\Programming Research Algorithms\Research\Ex5\myvenv\.myvenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'D:\Projects\Development\Courses\Python\Programming Research Algorithms\Research\Ex5\myvenv\.myvenv\Scripts\deactivate.nu'
